    ...
    <div class="w-full grid place-items-center">
        <form method="POST" action="{{ route('stores.store') }}" class="w-3/5 grid place-items-center my-5">
            ...
            <div class="border border-gray-500 rounded-lg w-1/3 grid place-items-center">
                ...
                <button type="submit" class="my-3 text-gray-500 dark:text-gray-200 hover:text-green-500 dark:hover:text-green-300 font-semibold text-xl leading-tight">Add Store</button>
            </div>
        </form>
    </div>
</x-app-layout>